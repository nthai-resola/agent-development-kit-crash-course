"""
Simple test for session management in the Orchestrator Agent.
"""
...
async def run_tests():
    ...
    try:
        # Create a finding directly instead of using the method with relative imports
        ...
        orchestrator.session_state["accumulated_findings"].append({
            "title": "Test Finding",
            "content": "This is a test finding.",
            "categories": ["Test"],
            "sources": ["test.com"]
